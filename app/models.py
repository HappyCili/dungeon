...
DAILY_TASKS: tuple[DailyTaskDefinition, ...] = (
    ...
    DailyTaskDefinition(103, "铁匠铺锻造", 5, 20, False, "尚未接入", "缺少普通锻造适配器"),
